...
class ForumMemberProfileTest extends FunctionalTest
{
    ...
    public function testMemberProfileSuspensionNote()
    {
        ...
        $normalMember = $this->objFromFixture('SilverStripe\\Security\\Member', 'test1');
        ...
        $suspendedMember = $this->objFromFixture('SilverStripe\\Security\\Member', 'suspended');
    ...
    public function testMemberProfileDisplays()
    {
        ...
        $this->get('ForumMemberProfile/show/' . $this->idFromFixture('SilverStripe\\Security\\Member', 'test1'));
        ...
        $this->get('ForumMemberProfile/show/' . $this->idFromFixture('SilverStripe\\Security\\Member', 'test2'));
