...
class ForumHolder extends Page {
	...
	function getCMSFields() {
		...
		$fields->addFieldsToTab("Root.Messages", array(
			...
			new HTMLEditorField("ProfileAbstract","Message to show on Member Profile page"),
			new HTMLEditorField("EditProfileAbstract","Message to show on Edit Member Profile page"),
